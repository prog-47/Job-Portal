...
const NavigationItem = ({item, isActive, onClick, isCollapsed}) => {
    ...
    return <button
            ...
            className={`w-full flex items-center px-3 py-2.5 text-sm font-medium rounded-lg transition-al duration-200 group ${
               isActive
...
export default function DashboardLayout({activeMenu, children}){
   ...
   useEffect(() => {
    ...
    return () => document.removeEventListener("clcik",handleClickOutside);
   },[profileDropdownOpen]);
   ...
   const sidebarCollapsed = !isMobile && false; 
    ...
    return( 
        <div className="flex h-screen bg-gray-50">
            {/* Sidebar */} 
            <div
             className={`fixed inset-y-0 l eft-0 z-50 transition-transform duration-300 transform
             ${
               isMobile
               ? sidebarOpen
                ? "translate-x-0"
            ...
            >
             {/* company Logo */}
             <div className="flex items-center h-16 border-b border-gray-200 pl-8">
                {!sidebarCollapsed ? (
                    ...
                    <div className="h-8 w-8 bg-gradient-to-br from-blue-600 to-blue-700 felx items-center justify-center">
            ...
            {isMobile && sidebarOpen && (
                <div
                 className="fixed inset-0 bg-black bg-opcity-25 z-40 backdrop-blur-sm"
                ...
                <div className="flex items-center space-x-4">
                    {isMobile && (
                        <button
                         ...
                         className="p-2 rounded-xl hover:gg-gray-100 transition-colors duration-200"
                        >
                            {sidebarOpen ? (
