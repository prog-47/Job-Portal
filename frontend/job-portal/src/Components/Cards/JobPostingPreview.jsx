...
export default function JobPostingPreview({formData, setIsPreview}){
            ...
            <div className=''>
                ...
                <div className='px-0 pb-8 space-y-8'>
                    ...
                    <div className='relative overflow-hidden bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-100 p-6 rounded-2xl'>
                        <div className='absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-emerald-400/10 to-teal-400/10 rounded-full -translate-16 translate-x-16'>
                        </div>
                        <div className='relative z-10'>
                            <div className='flex items-center justify-between'>
                                ...
                                <div className='hidden md:flex item-center space-x-2 text-sm text-emerald-700 bg-emerald-100 px-3 py-1 rounded-full'>
                ...
                {/* Requirements */}
                <div className='space-y-4'>
                    <h3 className='text-2xl font-bold text-gray-900 items-center space-x-3'>
                        <div className='w-1 h-8 bg-gradient-to-b from-purple-500 to-pink-600 rounded-full'></div>
                        <span className='text-base md:text-lg'>What We're Looking For</span>
                    </h3>
                    <div className='bg-gradient-to-br from-purple-50 border border-purple-100 rounded-xl p-6'>
                        <div className='text-sm text-gray-700 leading-relaxed whitespace-pre-wrap'>
