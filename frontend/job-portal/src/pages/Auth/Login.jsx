    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4 ">
            ...
            >
                ...
                <form inSubmit={handleSubmit} className="space-y-6">
                    {/* Email */}
                    <div>
                        ...
                        <div className="relative ">
                            <Mail className="absolute left-3 top-3 transform -translate-y-0.5 text-gray-500 w-5 h-5"/>
                            <input 
                             type="text"
                             name="email"
                    ...
                    <div className="block text-sm font-medium text-gray-700 mb-2">
                        ...
                        <div className="relative ">
                            <Lock className="absolute left-3 top-3 transform -translate-y-0.5 text-gray-400 w-5 h-5"/>
                            <input 
                            ...
                            <button
                             ...
                             className="absolute right-3 top-3 -translate-y-0.5 text-gray-400 hover:text-gray-600"
                            >
