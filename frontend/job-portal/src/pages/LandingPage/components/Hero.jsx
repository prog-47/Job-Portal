            ...
            <div className="container mx-auto px-4">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <motion.div
                     ...
                     className="grid grid-cols-l md:grid-cols-3 gap-8 max-w-2xl mx-auto"
                    >
                        {stats.map((stat, index)=>(
                            <motion.div
                             ...
                             className="flex flex-col items-center space-y-2 p-4 rounded-xl hover:bg-gray-50 transition-all"
                            >
