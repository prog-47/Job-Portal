...
import { Save, X, Trash2, Images } from "lucide-react";
                                    ...
                                    <div>
                                        <label className="block">
                                            ...
                                            <input 
                                             ...
                                             className="block w-full text-sm text-gray-500 file:mr-1 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100 transition-colors" 
                                            />
                                        </label>
                                    </div>
                                </div>
