...
export default function EmployerProfilePage(){
    ...
    const [profileData, setProfileData ] = useState({
        name: user?.name || "kacem bekelli",
        email: user?.email || "kacembekelli@gmail.com",
        avatar : user?.avatar || Images,
        companyName : user?.companyName || "ITSol",
        companyDescription : user?.companyDescription || "IT Services and Consulting , building a software, deployment, SSL/TLS, Cloud",
        companyLogo : user?.companyLogo || companyLogo,
    });
                                ...
                                <div className="space-y-6">
                                 ...
                                 <div className="flex items-center space-x-4">
                                    <img 
                                     ...
                                     alt="Company Logo"
                                     className="w-20 h-20 rounded-lg object-center border-4 border-blue-50" 
                                    />
                                    <div>
                                        <h3 className="text-lg font-semibold text-gray-800">
