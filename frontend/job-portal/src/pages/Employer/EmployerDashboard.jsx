...
import { QUick_Action } from "../../utils/data.js";

function Card({title, headerAction, subtitle, className, children }){
                ...
                <Card>
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        {QUick_Action.map((action, index)=>(
                            ...
                            >
                                <div className={`p-2 rounded-b-lg ${action.color}`}>
