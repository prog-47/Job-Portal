...
export default function EditProfileDetails({formData,handleImageChange,handleInputChange,handleSave,handleCancel,saving,uploading}){
    return (<DashboardLayout activeMenu='company-profile'>
             {formData && 
                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <input 
                                     ...
                                     className="w-full px-4 py-3 border border-gray-300 rounded-lg fonus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <input 
                                     ...
                                     className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 foucs:ring-blue-500 focus:border-transparent transition-all"
                                     placeholder="Enter company name" 
                                    />
                                </div>

                                {/* Company Description */}
                                <div className="block text-sm font-meduim text-gray-700 mb-2">
                                    <label className="">
                                        Company Description
                                    </label>
                                    <textarea 
