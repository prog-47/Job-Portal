 ...
 */
    ...
    return (<DashboardLayout activeMenu='manage-jobs'>
              {!loading && (
                                    ...
                                    >
                                        ...
                                        <div className="bg-gradient-to-r from-blue-500 to-blue-600 px-6 py-4">
                                            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                                                ...
                                                <div className="bg-white/20 backdrop-blue-sm rounded-lg px-3 py-2">
                                                    ...
                                                    >
                                                        <div className="flex items-center gap-4">
                                                            ...
                                                            <div className="flex-shrink-0">
                                                                {application.applicants.avatar ? (
                                                                    <img 
                                                                     src={application.applicants.avatar} 
                                                                     alt={application.applicants.name} 
                                                                     className="h-12 w-12 rounded-full object-cover"
                                                                    />
                                                                ):(
                                                                    <div className="h-12 w-12 rounded-full bg-blue-100 flex items-center justify-center">
                                                                        <span className="text-blue-600 font-semibold">
                                                                            {getInitials(application.applicants.name)}
                                                                        </span>
                                                                    </div>
                                                                )}
                                                            </div>
