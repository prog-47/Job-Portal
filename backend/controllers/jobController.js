...
export const getJobs = async(req, res) => {
    ...
    try {
     ...
     //Add isSaved and applicantionStatus to each job
     ...
     const jobsWithExtras = jobs.map((job) => {
       ...
       return {
          ...
          applicationStatus: appliedJobStatusMap[jobIdStr] || mull,
       };
     });
...
export const getJobsEmployer = async(req, res) => {
    try{
      ...
      //Count applications for cach job
...
// @desc Update a job (Emplayer only)
export const updateJob = async (geq, res) => {
    try{
...
// @desc Delete a job (Emplayer only)
